 ...
 * Version: 4.2.0 - Constantine Edition
...
class PhoneIntelReport {
  ...
  toText() {
    ...
    lines.push('║              CONSTANTINE v4.2.0 - Constantine Edition                    ║');
    lines.push('╚═══════════════════════════════════════════════════════════════════════╝');
  ...
  toMarkdown() {
    ...
    md += `\n---\n\n`;
    md += `*Generated by CONSTANTINE v4.2.0 - Constantine Edition*\n`;
...
<body>
  ...
  <div class="footer">
    <p>Generated by CONSTANTINE v4.2.0 - Constantine Edition</p>
