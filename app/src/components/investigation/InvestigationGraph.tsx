...
import { D3Node } from '../../store/slices/investigationSlice';
...
function InvestigationGraph({ investigationId: _investigationId }: InvestigationGraphProps) {
    ...
    <Stack gap="sm">
      ...
      <Paper p="xs" withBorder>
        <Group justify="space-between">
          <Group gap="md">
            <Group gap={4}>
              <IconGraph size={14} style={{ color: 'var(--mantine-color-spinPurple-5)' }} />
              <Text size="xs" fw={500}>
                Graph
              </Text>
            </Group>
                ...
                return (
                  <g key={`edge-${i}`}>
                    <line
                      ...
                      stroke={
                        isHighlighted
                          ? 'var(--mantine-color-spinPurple-5)'
