...
const spinPurple: MantineColorsTuple = [
  '#f3e8ff',
  '#e2cffc',
  '#c49df7',
  '#a568f2',
...
export const spinTheme = createTheme({
  primaryColor: 'spinPurple',
  primaryShade: 6,
    ...
    TextInput: {
      styles: {
        input: {
          ...
          '&:focus': {
            borderColor: 'var(--mantine-color-spinPurple-6)',
          },
        },
      },
    },
...
export const spinCssVariables = `
  :root {
    --spin-glow-purple: 0 0 20px rgba(123, 31, 235, 0.4);
    --spin-glow-green: 0 0 20px rgba(28, 223, 102, 0.4);
    --spin-glow-blue: 0 0 20px rgba(56, 141, 255, 0.4);
    --spin-border-glow: 0 0 10px rgba(123, 31, 235, 0.2);
  }
`;
