  ...
  return (
    <Stack gap="md">
      <Group justify="space-between">
        <Group>
          <IconTimeline size={20} style={{ color: 'var(--mantine-color-madroxPurple-6)' }} />
          <Title order={4}>Investigations</Title>
          <Badge color="madroxPurple" variant="light">
            ...
            <Stack gap="md">
              ...
              <Card
                ...
                style={{
                  ...
                  borderLeft: '3px solid var(--mantine-color-madroxPurple-6)',
                }}
              >
                <Group justify="space-between">
                  <Stack gap={2}>
